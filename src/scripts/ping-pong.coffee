...
#
# Commands:
#   hubot I lost to <user> (OPTIONAL)<score_1> to <score_2> - Adds 1 loss to user and 1 win to competitor for ping pong leaderboard.
#   hubot I beat <user> (OPTIONAL)<score_1> to <score_2> - Adds 1 win to user and 1 loss to competitor for ping pong learderboard.
#   hubot leaderboard - Displays ping pong player leaderboard (default sort is by "rating").
#   hubot leaderboard by <attribute> - Displays ping pong player leaderboard sorted by attributes (acceptable values: "wins", "losses", "rating").
#   hubot last <number> matches - Displays last n ping pong playermatches 
#
# Author:
#   rclosner
